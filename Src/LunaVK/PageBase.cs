...
namespace App1uwp
{
  public class PageBase : Page
  {
    ...
    private CustomFrame CFrame
    {
      get
      {
        return Window.Current.Content is CustomFrame 
                    ? Window.Current.Content as CustomFrame 
                    : (CustomFrame) null;
      }
    }
    ...
    protected void SetUpPageAnimation()
    {
      ...
      paneThemeTransition1.Edge = EdgeTransitionLocation.Right;
      PaneThemeTransition paneThemeTransition2 = paneThemeTransition1;
      transitionCollection.Add(paneThemeTransition2);
      this.Transitions = transitionCollection;
    }
    ...
    private void PageBase_Loaded(object sender, RoutedEventArgs e)
    {
      ...
      if (((UserControl) this).Content is Grid)
      {
        ...
        content.ManipulationMode = ((ManipulationModes) 65537);
