...
// Type: App1uwp.UC.Attachment.AttachVideoUC
...
{
  public sealed class AttachVideoUC : UserControl, IComponentConnector
  {
    [GeneratedCode("Microsoft.Windows.UI.Xaml.Build.Tasks", " 4.0.0.0")]
    private bool _contentLoaded;

    public AttachVideoUC() => this.InitializeComponent();

    public AttachVideoUC(VKVideoBase a)
      : this()
    {
    ...
    {
      VKVideoBase dataContext = ((FrameworkElement) this).DataContext as VKVideoBase;
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("ms-appx:///UC/Attachment/AttachVideoUC.xaml"), (ComponentResourceLocation) 0);
    }
