...
namespace App1uwp.Library
{
  public sealed class MD5Core
  {
    ...
    public static byte[] GetHash(byte[] input)
    {
      if (input == null)
        throw new ArgumentNullException(nameof (input), "Unable to calculate hash over null input data");
      MD5Core.ABCDStruct ABCDValue = new MD5Core.ABCDStruct();
      ABCDValue.A = 1732584193U;
      ABCDValue.B = 4023233417U;
      ABCDValue.C = 2562383102U;
      ABCDValue.D = 271733878U;
      int ibStart;
      for (ibStart = 0; ibStart <= input.Length - 64; ibStart += 64)
    ...
    internal static void GetHashBlock(byte[] input, ref MD5Core.ABCDStruct ABCDValue, int ibStart)
    {
