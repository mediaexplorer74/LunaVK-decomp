...
namespace App1uwp
{
  public sealed class TestNotificationsPanel : PageBase, IComponentConnector
  {
    ...
    [GeneratedCode("Microsoft.Windows.UI.Xaml.Build.Tasks", " 4.0.0.0")]
    private Slider slUsers;
    [GeneratedCode("Microsoft.Windows.UI.Xaml.Build.Tasks", " 4.0.0.0")]
    private Slider slInterv;
    [GeneratedCode("Microsoft.Windows.UI.Xaml.Build.Tasks", " 4.0.0.0")]
    private Slider slLen;
    [GeneratedCode("Microsoft.Windows.UI.Xaml.Build.Tasks", " 4.0.0.0")]
    private Image image;
    [GeneratedCode("Microsoft.Windows.UI.Xaml.Build.Tasks", " 4.0.0.0")]
    private RectangleGeometry ProfileImageClipRect;
    [GeneratedCode("Microsoft.Windows.UI.Xaml.Build.Tasks", " 4.0.0.0")]
    ...
    public TestNotificationsPanel()
    {
      ...
      for (int index = 0; index < (int) ((RangeBase) this.slUsers).Maximum; ++index)
      {
        ...
        this._timers[index].put_Interval(TimeSpan.FromMilliseconds(((RangeBase) this.slInterv).Value * 1000.0 + (double) (index * 10)));
      }
    ...
    private void UpdateProfilePhoto(double width, double ratio)
    {
      ...
      if (cropPhoto != null)
      {
        ...
        if (flag)
        {
          ...
          this.ProfileImageClipRect.put_Rect(new Rect(0.0, -(top + 1.0), width, height1 + 1.0));
        }
        else
        {
          double left = Math.Min(0.0, Math.Max(width / 2.0 - num2, width - width1));
          this.ProfileImageMargin = new Thickness(left, 0.0, 0.0, 0.0);
          this.ProfileImageClipRect.put_Rect(new Rect(-(left + 1.0), 0.0, width + 1.0, height1));
        }
      }
      else
      {
      ...
      ((FrameworkElement) this.BackGrid).put_Width((double) this.ProfileImageWidth);
      ((FrameworkElement) this.BackGrid).put_Height(height1);
      ((FrameworkElement) this.image).put_Margin(this.ProfileImageMargin);
      this.Temp.put_Text(string.Format("ProfileImageWidth {0} ProfileImageHeight {1} requiredHeight {2}", (object) this.ProfileImageWidth, (object) this.ProfileImageHeight, (object) height1));
      this.Temp2.put_Text(string.Format("Rect.Left {0} Rect.Top {1} Rect.X {2} Rect.Y {3}", (object) this.ProfileImageClipRect.Rect.Left, (object) this.ProfileImageClipRect.Rect.Top, (object) this.ProfileImageClipRect.Rect.X, (object) this.ProfileImageClipRect.Rect.Y));
    }
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("ms-appx:///TestNotificationsPanel.xaml"), (ComponentResourceLocation) 0);
      this.BackGrid = (Grid) ((FrameworkElement) this).FindName("BackGrid");
      this.Temp = (TextBlock) ((FrameworkElement) this).FindName("Temp");
      this.Temp2 = (TextBlock) ((FrameworkElement) this).FindName("Temp2");
      this.slUsers = (Slider) ((FrameworkElement) this).FindName("slUsers");
      this.slInterv = (Slider) ((FrameworkElement) this).FindName("slInterv");
      this.slLen = (Slider) ((FrameworkElement) this).FindName("slLen");
      this.image = (Image) ((FrameworkElement) this).FindName("image");
      this.ProfileImageClipRect = (RectangleGeometry) ((FrameworkElement) this).FindName("ProfileImageClipRect");
    }
    ...
    public void Connect(int connectionId, object target)
    {
      switch (connectionId)
      {
        case 1:
          ...
          WindowsRuntimeMarshal.AddEventHandler<RoutedEventHandler>(new Func<RoutedEventHandler, EventRegistrationToken>(buttonBase.add_Click), new Action<EventRegistrationToken>(buttonBase.remove_Click), new RoutedEventHandler(this.Button_Click_1));
          break;
        case 2:
        ...
        case 4:
          ...
          WindowsRuntimeMarshal.AddEventHandler<RangeBaseValueChangedEventHandler>(new Func<RangeBaseValueChangedEventHandler, EventRegistrationToken>(rangeBase3.add_ValueChanged), new Action<EventRegistrationToken>(rangeBase3.remove_ValueChanged), new RangeBaseValueChangedEventHandler(this.Slider_ValueChanged3));
          break;
      }
      this._contentLoaded = true;
    }
